...
-- DBTITLE 1,Use The Sample databricks-datasets
-- MAGIC %python
-- MAGIC dbutils.fs.ls("/databricks-datasets/nyctaxi/tripdata/yellow/")

-- COMMAND ----------

DROP table if exists tblyellowtaxi;

-- COMMAND ----------

CREATE TABLE tblyellowtaxi
USING CSV
OPTIONS (path "/databricks-datasets/nyctaxi/tripdata/yellow/yellow_tripdata_2019-10.csv.gz", header "true")
